...
public class CASINO {
        ...
        while (!ini_juego) {
            ...
            switch (opcion_r) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    // uso del metodo usuarios() para salir del programa
    ...
    public static boolean usuarios(String accion, ArrayList<Integer> puntos) throws IOException, InterruptedException {
        switch (accion) {
            ...
            case "registro":
                ...
                break;
            // caso para salir del programa llamado desde el main()
            case "salir":
                borrarPantalla();
                System.out.println(titulo);
                System.out.println("\n\t\t\t\t          HASTA PRONTO\n");
    ...
    public static void menujuegos(int puntos) throws IOException, InterruptedException {
        ...
        // Mientras que la opción del menú de juegos no sea 5 (salir del programa), se repite infinitamente el código contenido dentro
        while (opcionMenu != 5) {
